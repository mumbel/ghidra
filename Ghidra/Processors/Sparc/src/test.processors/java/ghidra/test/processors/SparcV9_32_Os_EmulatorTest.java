...
public class SparcV9_32_Os_EmulatorTest extends ProcessorEmulatorTestAdapter {
	...
	public SparcV9_32_Os_EmulatorTest(String name) throws Exception {
		super(name, LANGUAGE_ID, COMPILER_SPEC_ID, REG_DUMP_SET);
	}

	@Override
	protected String getProcessorDesignator() {
		return "sparcV9_32_GCC_Os";
	}
	...
	public static Test suite() {
		return ProcessorEmulatorTestAdapter.buildEmulatorTestSuite(SparcV9_32_Os_EmulatorTest.class);
	}
}
