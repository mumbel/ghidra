...
public class SparcV9_32_O2_EmulatorTest extends ProcessorEmulatorTestAdapter {
	...
	public SparcV9_32_O2_EmulatorTest(String name) throws Exception {
		super(name, LANGUAGE_ID, COMPILER_SPEC_ID, REG_DUMP_SET);
	}

	@Override
	protected String getProcessorDesignator() {
		return "sparcV9_32_GCC_O2";
	}
	...
	public static Test suite() {
		return ProcessorEmulatorTestAdapter.buildEmulatorTestSuite(SparcV9_32_O2_EmulatorTest.class);
	}
}
