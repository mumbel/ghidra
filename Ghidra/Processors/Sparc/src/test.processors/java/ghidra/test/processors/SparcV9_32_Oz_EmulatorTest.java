...
public class SparcV9_32_Oz_EmulatorTest extends ProcessorEmulatorTestAdapter {
	...
	public SparcV9_32_Oz_EmulatorTest(String name) throws Exception {
		super(name, LANGUAGE_ID, COMPILER_SPEC_ID, REG_DUMP_SET);
	}

	@Override
	protected String getProcessorDesignator() {
		return "sparcV9_32_GCC_Oz";
	}
	...
	public static Test suite() {
		return ProcessorEmulatorTestAdapter.buildEmulatorTestSuite(SparcV9_32_Oz_EmulatorTest.class);
	}
}
