...
public class SparcV9_32_Ofast_EmulatorTest extends ProcessorEmulatorTestAdapter {
	...
	public SparcV9_32_Ofast_EmulatorTest(String name) throws Exception {
		super(name, LANGUAGE_ID, COMPILER_SPEC_ID, REG_DUMP_SET);
	}

	@Override
	protected String getProcessorDesignator() {
		return "sparcV9_32_GCC_Ofast";
	}
	...
	public static Test suite() {
		return ProcessorEmulatorTestAdapter.buildEmulatorTestSuite(SparcV9_32_Ofast_EmulatorTest.class);
	}
}
