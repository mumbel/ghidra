...
#define PCODE_BIOP_MIN2(typ)			\
  typ biopMin2##typ####typ(			\
			 typ lhs,		\
			 typ rhs) {		\
...
#define PCODE_BIOP_MAX2(typ)			\
  typ biopMax2##typ####typ(			\
			 typ lhs,		\
			 typ rhs) {		\
    return lhs <= rhs ? rhs : lhs;	       	\
  }
...
#define PCODE_BIOP_MULADD(typ)			\
  typ biopMultAdd##typ####typ(			\
			   typ lhs,		\
			   typ rhs,		\
			   typ a) {		\
    typ z;					\
...
#define PCODE_BIOP_MULSUB(typ)			\
  typ biopMultSub##typ####typ(			\
			   typ lhs,		\
			   typ rhs,		\
			   typ a) {		\
    typ z;					\
...
PCODE_BIOP_MULADD(i1);
PCODE_BIOP_MULADD(i2);
PCODE_BIOP_MULADD(i4);
PCODE_BIOP_MULADD(u1);
PCODE_BIOP_MULADD(u2);
PCODE_BIOP_MULADD(u4);

PCODE_BIOP_MULSUB(i1);
PCODE_BIOP_MULSUB(i2);
PCODE_BIOP_MULSUB(i4);
PCODE_BIOP_MULSUB(u1);
PCODE_BIOP_MULSUB(u2);
PCODE_BIOP_MULSUB(u4);
...
PCODE_BIOP_MULADD(i8);
PCODE_BIOP_MULADD(u8);

PCODE_BIOP_MULSUB(i8);
PCODE_BIOP_MULSUB(u8);
...
PCODE_BIOP_MULADD(f4);

PCODE_BIOP_MULSUB(f4);
...
PCODE_BIOP_MULADD(f8);

PCODE_BIOP_MULSUB(f8);
